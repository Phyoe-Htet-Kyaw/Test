                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><img src="uploads/<?php echo $item->photos ?>" width="50"></td>
                      ...
                      <td>
                        ...
                        <a href="user_feedback.php?id=<?php echo $item->id; ?>"><button type="button" class="btn btn-primary btn-sm">Feedback</button></a>
                      </td>
                    </tr>
                    <?php
                      }                
